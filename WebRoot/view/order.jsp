		...
		<div class="container-fluid">
				...
				<nav>
						<ul class="box-primary-nav">
								...
								<li><a href="main.html">Home</a> <i class="ion-ios-circle-filled color"></i></li>
								<li><a href="myself.html">MYSELF</a></li>
								<li><a href="wallet.html">WALLET</a></li>
								<li><a href="driver_order.html">ITINERARY</a></li>

								<li class="box-label"><a href="login.html">Exit</a></li>
	...
	<section class="contact_brick">
		<div class="container mt-100">
            ...
            <div class="contact-form bottom">
                ...
                <a id="submit_btn" class="default-btn gray-btn" style="float: right; " href="arrive?id=${tripinfo.id}">到达目的地<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
            </div>
		</div><!-- end container -->
	</section>
