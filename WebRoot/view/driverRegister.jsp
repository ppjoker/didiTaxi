	...
	<section class="contact_brick">
		<div class="container mt-100">
            ...
            <div class="contact-form bottom">
                <form id="main-contact-form" name="contact-form" method="post" action="driverRegister">
                <div class="col-md-6 col-sm-6 col-xs-12">
                
                    <div class="form-group">
                        <input type="text"  id="name" name="vehicleCode" class="form-control" required="required" placeholder="车牌号">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="vehicleColor" class="form-control" required="required" placeholder="汽车颜色">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="vehicleBrand" class="form-control" required="required" placeholder="汽车品牌">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="driverLicense" class="form-control" required="required" placeholder="驾驶证号">
                    </div>
                </div>
                ${driver.backnews}
                <div class="form-group">
                        <button id="submit_btn" type="submit" class="default-btn gray-btn">申请成为司机<i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                        <p>${userInfo.backnews}</p>
                        <div style="width: 100%;height: 50px;background: lightgrey;border-radius: 10px;text-align: center;padding-top: 10px;">
                        <a id="order" href="driverorder">开始接单<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                    	</div>
                </div>
                </form>
            </div>
