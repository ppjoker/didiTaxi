	...
	<section class="contact_brick">
		<div class="container mt-100">
            ...
            <div class="contact-form bottom">
                <form id="main-contact-form" name="contact-form" method="post" action="ppublish">
                <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="hidden" readonly="readonly" name="tel" value="${user.tel}"><br>
					<input type="hidden" readonly="readonly" name="name" value="${user.name}"><br>
                    <div class="form-group">
                        <input type="text" id="name" name="sp" class="form-control" required="required" placeholder="出发地">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="end" class="form-control" required="required" placeholder="终点地">
                    </div>
                    <div class="form-group">
                        <input type="datetime-local"  id="name" name="time" class="form-control" required="required" placeholder="出发时间">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="income" class="form-control" required="required" placeholder="00.00">
                    </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <button id="submit_btn" type="submit" class="default-btn gray-btn">发布行程<i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
