...
<body class="animsition">
	...
	<section class="contact_brick" style="margin-bottom:200px;">
		<div class="container mt-100">
			
            
            <div class="contact-form bottom">
                <form id="main-contact-form" name="contact-form" method="post" action="bankregister">
                ...
                <input type="hidden" readonly="readonly" name="tel" value="${user.tel}"><br>
                    ...
                    <div class="form-group">
                        <input type="text"  id="name" name="bankname" class="form-control" required="required" placeholder="银行卡名称">
                    </div>
                    <div class="form-group">
                        <input type="text"  id="name" name="bankcode" class="form-control" required="required" placeholder="银行卡号">
                    </div>
                    
                </div>
                <div class="form-group">
                        <button id="submit_btn" type="submit" type="submit" class="default-btn gray-btn">添加<i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
