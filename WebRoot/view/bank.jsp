...
<body class="animsition">
	...
	<section class="contact_brick">
		<div class="container mt-100">
            ...
            <div class="contact-form bottom" style="margin-bottom:100px;text-align: center;">
                	<c:forEach var="bank" items="${bank_list }">
                	<div style="border:1px solid lightgrey;width: 90%;height: 75px;padding-top: 10px;margin-bottom: 25px;padding-left: 20px;margin-left: 5%;">
                		<input type="text" name=""  style="border:none;background: none;float: left;" value="${bank.bankname }"><br>
                		<input type="text" name="" style="border:none;background: none;float: left;padding-left: 10px;" value="${bank.bancode }" >
                	</div>
                	</c:forEach>
                	<br>
                	<div style="width: 150px;height: 40px;border: 1px solid lightgrey;border-radius: 5px;"><a href="addbank">添加</a></div>
