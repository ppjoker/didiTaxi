	...
	<section class="contact_brick" style="margin-bottom:100px;">
		<div class="container mt-100">
            ...
            <div class="contact-form bottom" >
                <form id="main-contact-form" name="contact-form" method="get" action="sendemail.php">
                	<div style="border-bottom: 1px solid lightgrey;border-top:1px solid lightgrey;height: 50px;padding-top: 10px"><a href="yue?tel=${user.tel}">余额
                	</a>
					<div style="border-bottom: 1px solid lightgrey;border-top:1px solid lightgrey; height: 50px;margin-top: 20px;padding-top: 10px"><a href="bank?tel=${user.tel}">银行卡</a></div>
                	<div style="border-bottom: 1px solid lightgrey;border-top:1px solid lightgrey; height: 50px;margin-top: 20px;padding-top: 10px;"><a href="moneydetail?tel=${user.tel}">账单明细</a></div>
                </form>
            </div>
		</div><!-- end container -->
	</section>
