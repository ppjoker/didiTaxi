            ...
            <div class="contact-form bottom">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                	<div class="form-group">
                        <input type="text" name="name" id="name" class="form-control" required="required" placeholder="真实姓名">
                    </div>
                    <div class="form-group">
                        <input type="text" name="nickname" id="name" class="form-control" required="required" placeholder="昵称">
                    </div>
                    <div class="form-group">
                        <input type="password" name="pwd" id="name" class="form-control" required="required" placeholder="请输入6-16位字符组成的密码">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input type="text" name="tel" id="name" class="form-control" required="required" placeholder="手机号">
                    </div>
                    <div class="form-group">
                        <input type="text" name="age" id="name" class="form-control" required="required" placeholder="年龄">
                    </div>
                    <div class="form-group">
                        <input type="text" name="ps" id="name" class="form-control" required="required" placeholder="个性签名">
                    </div>
                    <div class="form-group">
                        <input type="text" name="professional" id="name" class="form-control" required="required" placeholder="职业">
                        <input type="radio" name="type" value="1">司机
  						<input type="radio" name="type" value="2">乘客<br>
                    </div>
                    <p>${userInfo.backnews}</p>
                    <div class="form-group">
                        <button id="submit_btn" type="submit" class="default-btn gray-btn"> 注册<i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                    </div>
                </div>
                </form>
            </div>
